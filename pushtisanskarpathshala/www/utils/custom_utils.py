...
def get_current_student():
	...
	try:
		...
		# print("\n\n\n get_current_student", student_id, "\n\n\n")
...
def get_portal_programs():
	...
	# print("\n\n\n utils.py get_portal_programs", portal_programs, "\n\n\n")
...
def evaluate_quiz_correct(quiz_response, quiz_name, course, program, time_taken):
	print("\n\n custom_utils.py evaluate quiz correct \n\n")
	import json
	...
	quiz_response = json.loads(quiz_response)
	quiz = frappe.get_doc("Quiz", quiz_name)
	print("\n\ncustom utils.py evaluate_quiz_correct quiz", quiz, "\n\n")
...
def get_quiz(quiz_name, course):
	try:
		quiz = frappe.get_doc("Quiz", quiz_name)
		print("\n\n\n custom utils.py get quiz quiz", quiz, "\n\n\n")
		questions = quiz.get_questions()
		print("\n\n\n custom utils.py get quiz questions", questions, "\n\n\n")
	except Exception:
...
# # CUSTOM CODE START
# def evaluate_correct(self, response_dict, quiz_name):
...
# 	# 	if response_dict[key] == answers[key]:
# 	# 		true_ans[key] = response_dict[key]
# 	# 	elif response_dict[key] != answers[key] and response_dict[key] != "None":
# 	# 		false_ans[key] = response_dict[key]
# 	# 	else:
# 	# 		no_ans[key] = response_dict[key]
#
# 	# return true_ans, false_ans, no_ans
# 	questions = [frappe.get_doc("Question", question.question_link) for question in self.question]
# 	answers = {q.name: q.get_answer() for q in questions}
# 	return answers
# # CUSTOM CODE END
...
def evaluate_correct(self, response_dict, quiz_name):
	questions = [frappe.get_doc("Question", question.question_link) for question in self.question]
	answers = {q.name: q.get_answer() for q in questions}
	print("\n\n\nquiz.py evaluate_correct", answers, "\n\n\n")
	return answers